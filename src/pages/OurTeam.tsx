...
export const OurTeam = () => {
	const teamMembers = [
		...
		},
		{
			name: "Michelle Bi",
			role: "Secretary",
			description: "Michelle has been an active member of Empower Initiative for over a year, where she has worked with students of different ages, building meaningful connections and supporting their academic growth. Through this experience, she has developed strong tutoring skills and the ability to adapt to a variety of learning styles. She also speaks Mandarin and uses it to support students in their learning. In addition to her work with Empower, Michelle is a member of her school’s fencing team. Outside of school and volunteering, Michelle enjoys traveling, baking, reading, and spending time with family and friends.",
		...
		},
		{
			name: "Felix Dschung",
			role: "Historian",
			description: "Felix is a founding member at Empower Initiative and has stayed committed to the organization for the past three years. Entering his final year of high school, he has now five years of mentoring and tutoring students. In school, he serves as the Captain of the Robotics Team, President of the Cybersecurity Club, and Co-President of Computer Science Club. Felix has taken 8 AP courses in high school so far and is proficient in English, Cantonese, and Mandarin.",
			email: "",
	...
	const alum = [
		...
		},
		{
			...
			imageUrl: "/team/alum/kirsten.jpg" // Add actual image path
		},
		{
			name: "Pamela Hao",
			...
			imageUrl: "/team/alum/Pamela.png" // Add actual image path
		}, {
			name: "Eric Mu",
			role: "Secretary",
	...
	return (
		<PageContainer>
			...
			<h1 className="text-deep-ocean text-center lg:text-left">Meet Our Alumni</h1>
			<div className='grid grid-cols-1 lg:grid-cols-2 gap-8 mt-8'>
